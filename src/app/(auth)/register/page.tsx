...
const GoogleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" {...props}>
    ...
    <path
      fill="#FBBC05"
      d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22c-.62-.63-1.07-1.38-1.39-2.22-.16-.48-.25-1-.25-1.53s.09-1.05.25-1.53z"
    />
    <path
      fill="#EA4335"
...
export default function RegisterPage() {
  ...
  const strengthColor = ["bg-red-500", "bg-yellow-500", "bg-blue-500", "bg-emerald-500"][strength - 1] || "bg-muted";
      ...
      <div className="glass-strong rounded-2xl border border-border/50 p-8 shadow-2xl">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Start transforming your notes with AI
          </p>
        </div>

        {/* Google OAuth */}
        <Button variant="outline" className="w-full h-11 gap-2.5" onClick={() => toast.info("Google OAuth configured in production")}>
